...
const CategoryPicker: React.FC<CategoryPickerProps> = ({ selectedCategory, onSelectCategory }) => {
  ...
  const categories = ['Inne', 'Msza', 'Uwielbienie', 'Maryjne', 'Do Ducha Świętego', 'Salezjańskie', 'Wielkanoc', 'Wielki Post', 'Adwent', 'Kolędy'];
  ...
  > = {
    Salezjańskie: {
      ...
      backgroundImage: require('./assets/src/SDB.jpeg'),
    },
